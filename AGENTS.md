...
- `make dev` — два терминала: `make dev-backend` и `make dev-frontend`
...
- Vite proxy forwards `/api/*` to `VITE_API_TARGET` (default: `http://localhost:5000`). Override with `.env` file.
